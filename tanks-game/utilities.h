...
bool inline isInRange(IntType t,IntType a,IntType b) //is t in the range [a,b] 
{
    return (t >= a && t <= b);
}
...
template <typename T> //width and height must be pos
