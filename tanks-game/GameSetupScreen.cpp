    ...
    bg(Application::getTexture(TitleBg))
{
    ...
    numPlayersSubMenu.add(sf::Color::Black, " 2");
    ...
    landTypeSubMenu.add(sf::Color::Black, "Flat");
    ...
    setupMenu.add(sf::Color::Black,"Players: "+std::to_string(numOfPlyrs),"Map Type: "+landtypes[l_type],std::string("Start"));
...
void GameSetupScreen::update(float dt)
{
    ...
    if(numPlayersSubMenu.getActive())
    {
        ...
        if(query >= 0)
        {
            ...
            setupMenu.clear();
            setupMenu.add(sf::Color::Black,"Players: "+std::to_string(numOfPlyrs),"Map Type: "+landtypes[l_type],"Start");
